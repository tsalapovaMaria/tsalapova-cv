        ...
        <footer className="footer">
            <div className="container-xl d-flex align-items-center justify-content-center">
                ...
                <div className="row">
                    ...
                    <div className="vk-container col-3">
                        <a href="http://vk.com/mtsalapova/">
                            <svg enable-background="new 0 0 512 512" version="1.1" viewBox="0 0 512 512">
                                <g>
                                    ...
                                    <path clip-rule="evenodd"
                                          ...
                                          fill="#d0e1d0" fill-rule="evenodd"/>
                                </g>
                            </svg>
                        </a>
                    </div>
                    <div className="inst-container col-3">
                        <a href="http://instagram.com/tsalapova.m/">
                    ...
                    <div className="yt-container col-3">
